function [f,x,xp,y,yp,eta] = rbc_sv_FGR(STDA,STDSIG)
...
f = [fc;fk;fa;fsiga;feps_a;feps_sig;fa_ba;fsiga_ba];

y  = [ln_c_cu  ln_a_cu  ln_siga_cu];
yp = [ln_c_cup ln_a_cup ln_siga_cup]; 
x  = [ln_k_cu  ln_a_ba  ln_siga_ba  eps_a_cu  eps_sig_cu];
xp = [ln_k_cup ln_a_bap ln_siga_bap eps_a_cup eps_sig_cup];
